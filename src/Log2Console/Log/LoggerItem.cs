    ...
    public class LoggerItem
    {
        ...
        internal bool Enabled
        {
            ...
            set
            {
                ...
                foreach (var item in LogMessages) EnableLogMessage(item, _enabled && IsItemToBeEnabled(item));
        ...
        internal void UpdateLogLevel()
        {
            ...
            foreach (var item in LogMessages) EnableLogMessage(item, IsItemToBeEnabled(item));

            foreach (var kvp in Loggers) kvp.Value.UpdateLogLevel();
        ...
        {
            var item = new LogMessageItem(this, logMsg) {Enabled = Enabled};
        ...
        private void DoSearch(string str)
        {
            ...
            // Iterate call
            foreach (var kvp in Loggers) kvp.Value.DoSearch(_searchedText);
        }
