...
namespace Log2Console.Settings
{
    ...
    public sealed class UserSettings
    {
        ...
        [NonSerialized] private Dictionary<string, int> _columnProperties = new Dictionary<string, int>();


        private FieldType[] _csvColumnHeaderFields;

        [NonSerialized] private Dictionary<string, FieldType> _csvHeaderFieldTypes;
        ...
        [NonSerialized] private Dictionary<string, string> _sourceCodeLocationMap;
        ...
        {
            get => _columnConfiguration ?? (ColumnConfiguration = DefaultColumnConfiguration);
            set
            {
        ...
        {
            get => _csvColumnHeaderFields ?? (CsvHeaderColumns = DefaultCsvColumnHeaderConfiguration);
            set
            {
        ...
        {
            get => _sourceLocationMapConfiguration;
            set
            {
        ...
        {
            get => _messageDetailConfiguration ?? (MessageDetailConfiguration = DefaultDetailsMessageConfiguration);
            set => _messageDetailConfiguration = value;
        }
        ...
        private void UpdateCsvColumnHeader()
        {
            ...
            foreach (var column in CsvHeaderColumns) _csvHeaderFieldTypes.Add(column.Name, column);
        }
